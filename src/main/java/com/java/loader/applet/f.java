...
implements MouseListener {
    ...
    public final void mouseEntered(MouseEvent mouseEvent) {
        ...
        JLabel label = new JLabel("<html><b color=\"red\"><i>Currently disabled</b></i><br>VeneClicker no longer simulates mouse movements for the user.<br><br><code><span bgcolor=\"#6A6D72\">|X-Axis|</span></code> (Inactive) The absolute value of the x-axis jitter range.<br><code><span bgcolor=\"#6A6D72\">|Y-Axis|</span></code> (Inactive) The absolute value of the y-axis jitter range.</html>");
